...
There is one more Python file for SAC on MuJoCo using the shaped rewards: 
```bash
generate_SAC_inferred_output_parameters.py
```
which can be used for a hyperparameter search using the shaped rewards.
